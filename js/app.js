...
const app = {
    ...
    translations: {
        uk: {
            ...
            instr_qs_step1: '1️⃣ <strong>Увійдіть</strong> через Google-акаунт',
            instr_qs_step2: '2️⃣ <strong>Заповніть профіль</strong> — вкажіть ім\'я, прізвище, телефон та номер квартири/ділянки (обов\'язково для голосування)',
            instr_qs_step3: '3️⃣ <strong>Створіть групу</strong> або <strong>приєднайтесь</strong> до існуючої за 6-значним кодом',
            instr_qs_step4: '4️⃣ <strong>Голосуйте</strong> у активних голосуваннях або створюйте власні',
            instr_qs_step5: '5️⃣ Слідкуйте за результатами у вкладці <strong>Сповіщення</strong>',
            ...
            instr_voting_types: '🗳️ Типи голосування',
            ...
            instr_freeze_title: '❄️ Заморозка учасника (BETA)',
            ...
            instr_rules: '⚖️ Правила та терміни',
        ...
        en: {
            ...
            instr_qs_step1: '1️⃣ <strong>Sign in</strong> with your Google account',
            instr_qs_step2: '2️⃣ <strong>Complete your profile</strong> — enter name, phone, and apartment/plot number (required to vote)',
            instr_qs_step3: '3️⃣ <strong>Create a group</strong> or <strong>join</strong> an existing one using the 6-digit code',
            instr_qs_step4: '4️⃣ <strong>Vote</strong> in active votings or create your own',
            instr_qs_step5: '5️⃣ Track results in the <strong>Notifications</strong> tab',
            ...
            instr_freeze_title: '❄️ Freeze Member (BETA)',
            ...
            instr_rules: '⚖️ Rules & Timeframes',
        ...
        ru: {
            ...
            instr_qs_step1: '1️⃣ <strong>Войдите</strong> через Google-аккаунт',
            instr_qs_step2: '2️⃣ <strong>Заполните профиль</strong> — укажите имя, фамилию, телефон и номер квартиры/участка (обязательно для голосования)',
            instr_qs_step3: '3️⃣ <strong>Создайте группу</strong> или <strong>присоединитесь</strong> к существующей по 6-значному коду',
            instr_qs_step4: '4️⃣ <strong>Голосуйте</strong> в активных голосованиях или создавайте свои',
            instr_qs_step5: '5️⃣ Следите за результатами во вкладке <strong>Уведомления</strong>',
            ...
            instr_freeze_title: '❄️ Заморозка участника (BETA)',
